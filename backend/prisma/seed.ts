...
const STRETCH_COLOR = 'F5A623'; // mustard
...
const practices: Prisma.PracticeCreateInput[] = [
  {
    ...
    thumbnailUrl: thumbnail('Morning Stretch', STRETCH_COLOR),
  },
  {
  ...
  },
  {
    ...
    intensity: 'LOW',
    videoUrl: MUX_DEMO,
    thumbnailUrl: thumbnail('Wind-Down', STRETCH_COLOR),
  },
  {
    id: 'seed-stretch-mat-30-fullbody',
    title: 'Full-Body Deep Stretch',
    type: 'STRETCHING',
    durationMinutes: 30,
    equipment: 'MAT',
    difficulty: 'INTERMEDIATE',
    bodyFocus: ['full body', 'flexibility'],
    intensity: 'LOW',
    videoUrl: BIPBOP_4X3,
    thumbnailUrl: thumbnail('Deep Stretch', STRETCH_COLOR),
  },
  {
  ...
  },
  {
    ...
    intensity: 'MEDIUM',
    videoUrl: BIPBOP_16X9,
    thumbnailUrl: thumbnail('Kettlebell Basics', PILATES_COLOR),
  },
  {
  ...
  },
  {
    ...
    intensity: 'MEDIUM',
    videoUrl: BIPBOP_16X9,
    thumbnailUrl: thumbnail('Band Arms', YOGA_COLOR),
  },
  {
    id: 'seed-pilates-bands-30-glutes',
    title: 'Resistance Band Glute Burn',
    type: 'PILATES',
    durationMinutes: 30,
    equipment: 'RESISTANCE_BANDS',
    difficulty: 'INTERMEDIATE',
    ...
    intensity: 'HIGH',
    videoUrl: MUX_DEMO,
    thumbnailUrl: thumbnail('Band Glutes', PILATES_COLOR),
  },
];
